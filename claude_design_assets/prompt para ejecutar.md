...
Necesito una presentación de defensa de tesis universitaria de 18 slides para 25–30 minutos. El trabajo se llama "Evaluación Automatizada de Técnica en Ejercicios de Fitness mediante Aprendizaje Profundo y Visión por Computadora". Lo presentaré ante un tribunal académico de ingeniería en UCASAL (Argentina).
...
**El output debe ser editable** (PPTX o Canva), no HTML.
...
- **Números destacados:** misma sans-serif pero en tamaño muy grande, peso bold — que los números "impacten" visualmente
...
- Mucho espacio blanco (o espacio oscuro) — no llenar todo
...
- Preferir que las imágenes tengan tratamiento consistente (mismo estilo de recorte, mismos márgenes)
...
- Función: analiza 48 frames completos y clasifica el movimiento
