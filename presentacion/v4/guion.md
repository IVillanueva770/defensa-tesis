# Guion de exposición (v4)

Ajustado al orden final resultante después de aplicar los cambios del `cambios-sobre-v2.md`. 23 slides, total ~18–19 min + margen para pausas y puentes verbales.

Primera persona, tono conversacional. Tiempo estimado entre paréntesis.
...
"Voy a estructurar la charla en cinco momentos. Primero, la pregunta que movió todo el proyecto. Después, el sistema que construí para responderla. Luego les voy a contar el recorrido experimental, porque hubo tres intentos antes de llegar al número final. Cuarto, los resultados. Y para cerrar, qué abre este trabajo hacia adelante."

---

> **PUENTE al Acto I**: silencio breve. La última palabra fue "adelante", la primera del siguiente slide es la pregunta.

### 3 — La pregunta (45 seg)
...
### 5 — Las alternativas existentes (45 seg)
...
### 10 — El problema del tracking (60 seg)
...
### 17 — Resultados por clase (50 seg)
